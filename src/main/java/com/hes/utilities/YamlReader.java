...
public class YamlReader {
    ...
    /**
     * Reads YAML data from the specified file and returns it as a map.
     *
     * @param filePath the path to the YAML file
     * @return a {@code Map<String, Object>} containing the YAML data,
     * or an empty map if the file is empty or not found
