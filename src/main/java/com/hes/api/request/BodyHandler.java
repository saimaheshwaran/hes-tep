...
/**
 * The {@code BodyHandler} interface defines methods for handling and manipulating content such as JSON or XML.
 * It provides methods to convert objects to string representations, read content, update content, and delete nodes.
 */
