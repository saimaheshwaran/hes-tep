...
import com.hes.utilities.FileUtils;
...
import static com.hes.api.support.PayloadValidationsHelpers.compareValues;
import static com.hes.api.support.PayloadValidationsHelpers.handleMixedList;
import static com.hes.utilities.ExceptionUtils.logErrorAndThrowIfNull;

/**
 * The {@code PayloadValidations} class provides methods for validating REST API responses.
 * It includes methods for validating string, boolean, and numeric fields, as well as JSON content.
 */
