...
import com.hes.utilities.JsonUtils;

import java.util.HashMap;
import java.util.Map;
import java.util.Objects;

import static com.hes.utilities.CommonUtils.isNullOrEmpty;
import static com.hes.utilities.StringUtils.secret;

/**
 * The {@code DriverApiOperations} class provides methods for configuring and executing REST API requests.
 * It supports setting various request parameters, executing requests, and handling responses.
 */
public class DriverApiOperations {
    ...
    private Map<String, String> PATH_PARAMS = new HashMap<>();
    ...
    private Map<String, String> FORM_PARAMS = new HashMap<>();
    ...
    /**
     * Sets the base URI for the API or web service being tested.
    ...
    /**
     * Sets the base path for the API or web service being tested.
    ...
    /**
     * Sets the endpoint for the API or web service being tested.
    ...
    /**
     * Sets the path parameters for the API request.
     * This method clears the Map and then sets newly passed values.
     *
     * @param pathParams The path parameters to be set.
     */
    ...
    /**
     * Manually set the body for the request.
     *
    ...
    /**
     * Resets the request data, ensuring that all instance variables are cleared.
     ...
     * called after each request, especially in contexts like unit tests or
