...
public class MapUtils {
    ...
    /**
     * Converts the given Map's keys and values to string using {@code String.valueOf()}
     *
     * @param inputMap any Map
     * @return input map with String keys and values or empty map if inputMap is null.
     */
