...
import com.tep.utilities.StringToType;
...
public class JsonApiRequestTest {
    ...
    private final ApiRequest handler = ApiRequestFactory.forJson();
    ...
    public void testReadJson() {
        ApiRequest handler = ApiRequestFactory.forJson();
    ...
    public void test_pojo_update() {
        ...
        String personJson = ApiRequestFactory.forJson().toString(person);
        assertEquals(personJson, "{\"name\":\"Bob\",\"age\":30}");
        String updatedPerson = ApiRequestFactory.forJson().update(personJson, "$.name", 2);
    ...
    public void testCreateObjectFromScratch() {
        String initialJson = "{}";
        ApiRequest handler = ApiRequestFactory.forContent(initialJson);
